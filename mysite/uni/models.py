...
class Section(models.Model):
    ...
    building = models.ForeignKey(Classroom, models.DO_NOTHING, db_column='building', blank=True, null=True,related_name="+")
    room_number = models.OneToOneField(Classroom, models.DO_NOTHING, db_column='room_number', to_field='room_number', blank=True, null=True)
...
class Takes(models.Model):
    ...
    sec = models.ForeignKey(Section, models.DO_NOTHING, to_field='sec_id',related_name="+")
    semester = models.ForeignKey(Section, models.DO_NOTHING, db_column='semester',related_name="+", to_field='semester')
...
class Teaches(models.Model):
    ...
    course = models.OneToOneField(Section, models.DO_NOTHING,related_name="+")
    sec = models.ForeignKey(Section, models.DO_NOTHING, to_field='sec_id',related_name="+")
    semester = models.ForeignKey(Section, models.DO_NOTHING, db_column='semester', to_field='semester',related_name="+")
    year = models.ForeignKey(Section, models.DO_NOTHING, db_column='year', to_field='year')
